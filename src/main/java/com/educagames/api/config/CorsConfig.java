 ...
 * 
 * <p>Durante o desenvolvimento, pode-se liberar todas as origens,
 * métodos e headers.</p>
 *
 * <p>⚠️ Em produção, é recomendado especificar apenas as origens reais
 * do frontend que terão acesso à API.</p>
 */
@Configuration
